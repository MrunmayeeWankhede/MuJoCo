...
env = gym.make("myoArmReachRandom-v0")  #load the full hand/forearm model
...
plt.title("MyoArm: which muscles move which joints + which direction")
plt.tight_layout()

#save the heatmap to a file
plt.savefig("results/arm_muscle_joint_heatmap.png", dpi=150)
print("Heatmap saved to results/arm_muscle_joint_heatmap.png")
